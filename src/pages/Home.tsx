...
export default function Home({ hideNavbar = false }) {
  return (
    <div className={`h-screen w-full relative ${hideNavbar ? "pt-6" : ""}`}>
      ...
      <section className="h-screen w-full snap-start relative flex items-start justify-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl">
          ...
          {/* Title */}
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-200">
          ...
          {/* CTA Button — KECIL & LANGSUNG SLIDE */}
          <div className="mt-12 animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-700">
            <button 
              id="go-cubes"
              className="inline-block px-6 py-3 bg-primary text-primary-foreground rounded-lg font-semibold text-base hover:scale-105 transition-transform shadow-[0_0_20px_rgba(0,255,255,0.3)] hover:shadow-[0_0_30px_rgba(0,255,255,0.5)]"
            >
